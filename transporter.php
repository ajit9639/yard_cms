                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="action">
                                                ...
                                                <a href='transporter_add.php?id=<?php echo $row["id"] ?>' class="get_id"><i
                                                        class="material-icons">edit</i></a>
                                                <a href='transporter_add.php?id=<?php echo $row["id"] ?>&type=delete'
