...
<!--middle Row Section-->
    ...
    <div class="middle_row">
        <label class="left" style="font-size: 11px;"> RR No. : <b><?= $query3['RR_No']?></b>, In Date : <b><?= $query3['RR_Date']?></b>, In Time : <b><?= $query3['Placement_Time']?></b>, Close Date : <b><?= $query1['rake_release_date']?></b>, Close Time : <b><?= $query1['rake_release_time']?></b></label>
        <br/>
           <label class="left" style="font-size: 11px;"> Company : <b><?= $query3['Company']?></b>, Transporter : <b><?= $query3['Transporter']?></b>, Material : <b><?= $query3['Material']?></b>, Box Type : <b><?= $query3['Box_Type']?></b>, RR Weight : <b><?= $query1['rr_wt']?></b>, Fuel Qty : <b><?= $query1['fuel_qty']?></b>, Total Box : <b><?= $query3['Total_Box']?></b></label>
    </div>
...
?>
                <tr>
                  <td width="40"><?= $s; ?></td>
                    <td><?= $query7['vehicle_no']?></td>
                    <td><?= $query7['vehicle_type']?></td>
                    <td><?= $query7['Date']?></td>
                    <td><?= $query7['date']?></td>
                    <td><?= $query7['']?></td>
                    <td><?= $query7['gross_weight'] - $query7['tare_weight'] ?></td>
                    <td><?= $query7['remarks']?></td>
                </tr>
