                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['Box_Type']; ?></td>
                                            <td><?php echo $row['Material']; ?></td>
                                            <td><?php echo $row['Total_Box']; ?></td>
                                            <td><?php echo $row['Company']; ?></td>
                                            <td><?php echo $row['Transporter']; ?></td>
                                            <td><?php echo $row['Billing_Head']; ?></td>
                                            <td><?php echo $row['Remarks']; ?></td>
                                            <td>
                                            <?php
                                            if($row["rake_status"] == 'close'){
                                            ?>
                                            <a href="rake_close.php?id=<?php echo $row["id"] ?>" class="btn btn-success"><?php echo $row["rake_status"] ?></a>
                                            <?php }else{ ?>
                                                <a href="loading_unloading_rake_update.php?id=<?php echo $row["id"] ?>" class="btn btn-danger"><?php echo $row["rake_status"] ?></a>
                                            <?php } ?>
                                            </td>
                                            <td class="action">

                                                <a href='rake_add.php?id=<?php echo $row["id"] ?>' class="get_id"><i
                                                        class="material-icons">edit</i></a>
                                                <a href='rake_add.php?id=<?php echo $row["id"] ?>&type=delete'
